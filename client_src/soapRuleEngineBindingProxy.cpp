...
int RuleEngineBindingProxy::GetSupportedMetadata(const char *endpoint, const char *soap_action, _tan__GetSupportedMetadata *tan__GetSupportedMetadata, _tan__GetSupportedMetadataResponse &tan__GetSupportedMetadataResponse)
{	struct soap *soap = this->soap;
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!static_cast<_tan__GetSupportedMetadataResponse*>(&tan__GetSupportedMetadataResponse)) // NULL ref?
		return soap_closesock(soap);
