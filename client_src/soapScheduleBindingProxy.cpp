...
{	ScheduleBindingProxy *dup = SOAP_NEW_COPY(ScheduleBindingProxy);
	if (dup)
...
int ScheduleBindingProxy::SetSchedule(const char *endpoint, const char *soap_action, _ns10__SetSchedule *ns10__SetSchedule, _ns10__SetScheduleResponse &ns10__SetScheduleResponse)
{	struct soap *soap = this->soap;
	struct __ns10__SetSchedule soap_tmp___ns10__SetSchedule;
	if (endpoint)
		soap_endpoint = endpoint;
	if (soap_action == NULL)
		soap_action = "http://www.onvif.org/ver10/schedule/wsdl/SetSchedule";
	soap_tmp___ns10__SetSchedule.ns10__SetSchedule = ns10__SetSchedule;
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
	soap_serialize___ns10__SetSchedule(soap, &soap_tmp___ns10__SetSchedule);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns10__SetSchedule(soap, &soap_tmp___ns10__SetSchedule, "-ns10:SetSchedule", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!static_cast<_ns10__SetScheduleResponse*>(&ns10__SetScheduleResponse)) // NULL ref?
		return soap_closesock(soap);
	ns10__SetScheduleResponse.soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns10__SetScheduleResponse.soap_get(soap, "ns10:SetScheduleResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int ScheduleBindingProxy::SetSpecialDayGroup(const char *endpoint, const char *soap_action, _ns10__SetSpecialDayGroup *ns10__SetSpecialDayGroup, _ns10__SetSpecialDayGroupResponse &ns10__SetSpecialDayGroupResponse)
{	struct soap *soap = this->soap;
	struct __ns10__SetSpecialDayGroup soap_tmp___ns10__SetSpecialDayGroup;
	if (endpoint)
		soap_endpoint = endpoint;
	if (soap_action == NULL)
		soap_action = "http://www.onvif.org/ver10/schedule/wsdl/SetSpecialDayGroup";
	soap_tmp___ns10__SetSpecialDayGroup.ns10__SetSpecialDayGroup = ns10__SetSpecialDayGroup;
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
	soap_serialize___ns10__SetSpecialDayGroup(soap, &soap_tmp___ns10__SetSpecialDayGroup);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns10__SetSpecialDayGroup(soap, &soap_tmp___ns10__SetSpecialDayGroup, "-ns10:SetSpecialDayGroup", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!static_cast<_ns10__SetSpecialDayGroupResponse*>(&ns10__SetSpecialDayGroupResponse)) // NULL ref?
		return soap_closesock(soap);
	ns10__SetSpecialDayGroupResponse.soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns10__SetSpecialDayGroupResponse.soap_get(soap, "ns10:SetSpecialDayGroupResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
